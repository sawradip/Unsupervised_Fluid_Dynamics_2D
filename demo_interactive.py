...
with torch.no_grad():
	while True:
		...
		dataset = Dataset(w,h,1,1,interactive=True,average_sequence_length=n_time_steps,max_speed=params.max_speed,dt=dt,types=["image"],images=["fish","cyber","smiley","wing"],background_images=["empty"])
